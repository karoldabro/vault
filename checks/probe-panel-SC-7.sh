...
[ -f "$root/tests/unit/probe-panel.bats" ] || { echo "tests/unit/probe-panel.bats not written yet — cannot say"; exit 2; }
...
for f in probe-panel v-team v-cr cr-rule-routing; do

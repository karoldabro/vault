...
| [[propose-front-gates]] | PROPOSE §3a opens with clarify (assumptions + AskUserQuestion for plan-changing doubts) then external research (ground vs the wild; reconcile contradicting consensus in writing); understand + ground before planning | `commands/v-work/steps/03-propose.md`, `commands/v-team/steps/03-propose-loop.md`, `commands/v-work/steps/01-analyze.md`, `tool-playbook.md` |

...
## Rule
In a repo whose `VAULT.md` declares `arch_profile: code` or `harness`, write no work item until
...
## Examples
- Do: draft `plans/<slug>.arch.md` from `templates/arch.md`, fix each refusal, then write work items.

...
| symbol name extraction | graphify-out/graph.json | new | the graph is built by a global tool and absent on a light install; a regex reads the source with no install |

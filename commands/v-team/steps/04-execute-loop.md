...
mechanism is shared** — `/v-capture` **Step 4d** carries each realised requirement's `REQ-NN` id inline
...
(`03-propose-loop.md` §f2) → **established dossier Behavior** (`/v-capture` §4d).

...
Identical to `/v-work` — vault grep and Serena (when present) are the token-saving backbone; plus the **Agent** tool for the critic panel (parallel spawn). Canonical health-check +
